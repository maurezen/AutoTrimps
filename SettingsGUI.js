...
//CORE:
    ...
    createSetting('AutoPerksMaxFallback', 'AutoPerks Max', 'With this on, the Auto Perks will fall back to using max when buying last perk in the selection. Helps vs some of the rounding errors.', 'boolean', false, null, 'Core');
    createSetting('AutoPerksFactor', 'AutoPerks Factor', 'A multiplier for the autoperks loop buying additive *_II perks. I cba to make that scale, so you gotta adjust this setting manually whenever your allocation starts getting slow. More multiplier = faster loop.', 'value', 100000000000, null, 'Core');
    //NewLine4
    document.getElementById('AutoPerksFactor').parentNode.insertAdjacentHTML('afterend','<br>');
    ...
    createSetting('HeliumHourChallenge', 'Portal Challenge', 'Automatically portal into this challenge when using helium per hour or custom autoportal. Custom portals after cell 100 of the zone specified. ', 'dropdown', 'None', ['None', 'Balance', 'Bublé', 'Melt', 'Quagmire', 'Decay', 'Electricity', 'Life', 'Crushed', 'Nom', 'Toxicity', 'Watch', 'Lead', 'Corrupted', 'Domination', 'Experience', 'Archaeology', 'Insanity', 'Mayhem', 'Nurture', 'Pandemonium', 'Alchemy', 'Hypothermia'], "Core");
...
// Nature settings:
    ...
    createSetting('AutoTriggerNatureDaily', 'Daily', 'Trigger empowerments of nature on a Daily run', 'dropdown', 'Wind', ['Off', 'Poison', 'Ice', 'Wind'], 'Nature');
    createSetting('AutoTriggerNatureChallenge', 'CInf', 'Trigger empowerments of nature on a Challenge run', 'dropdown', 'Off', ['Off', 'Poison', 'Ice', 'Wind'], 'Nature');
    createSetting('AutoTriggerNatureFiller', 'Filler', 'Trigger empowerments of nature on a filler run', 'dropdown', 'Off', ['Off', 'Poison', 'Ice', 'Wind'], 'Nature');
